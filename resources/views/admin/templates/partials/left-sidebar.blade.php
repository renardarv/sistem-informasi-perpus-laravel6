      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.report.top-book') }}"><i class="fa fa-circle-o text-yellow"></i> Buku Favorit</a></li>
            <li><a href="{{ route('admin.report.top-user') }}"><i class="fa fa-circle-o text-aqua"></i> Pengguna Teraktif</a></li>
          </ul>
        </li>
